...
the proteome and the phosphoproteome, from the epigenome to DNA mutations, each
...
biology* attempts to take as much of these levels as possible into account in
...
disease or adverse clinical outcome. While the sampling technology gives partial
insight to these issues, the other half of the solution, namely mathematical and
computational analyses of biological data, must unfortunately play catch up.
...
phosphoproteome, etc.), I have developed algorithms, programs, and a
...
([[diversitySelectionPaper]],[[clumpinessPaper]]), data visualization ([[clumpinessPaper]]),
and everything in-between.

* Publications

- Antell GC, Dampier W, Aiamkitsumrit B, Nonnemacher MR, Jacobson JM,
        Pirrone V, Zhong W, Kercher K, and Passic S, Williams JW,
        *Schwartz G*, Hershberg U, Krebs FC, and Wigdahl B. Utilization
        of HIV-1 envelope V3 to identify X4- and R5-specific Tat and LTR
        sequence signatures. /Retrovirology/ *13*, 32 (2016). [[http://retrovirology.biomedcentral.com/articles/10.1186/s12977-016-0266-9][doi:10.1186/s12977-016-0266-9]]
...
|----------------------------------------------------+-------------+-------------+-------------|
|                       clumpiness ([[clumpinessPaper]]) | [[https://github.com/GregorySchwartz/clumpiness][\(\bullet\)]] | [[http://hackage.haskell.org/package/clumpiness][\(\bullet\)]] | [[https://www.stackage.org/lts-8.20/package/clumpiness-0.17.0.0][\(\bullet\)]] |
...
|                  find-clumpiness ([[clumpinessPaper]]) | [[https://github.com/GregorySchwartz/find-clumpiness][\(\bullet\)]] | [[http://hackage.haskell.org/package/find-clumpiness][\(\bullet\)]] |             |
